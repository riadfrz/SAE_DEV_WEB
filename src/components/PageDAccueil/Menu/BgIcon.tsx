...
const BgIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 284 53' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <g filter='url(#filter0_d_118_2419)'>
      <path
        fillRule='evenodd'
        clipRule='evenodd'
    ...
    <defs>
      ...
      >
        ...
        <feBlend mode='normal' in2='BackgroundImageFix' result='effect1_dropShadow_118_2419' />
        <feBlend mode='normal' in='SourceGraphic' in2='effect1_dropShadow_118_2419' result='shape' />
      </filter>
    </defs>
  </svg>
);
