...
const Presentation = () => {
    return (
        ...
        <div >
            ...
            <div className={classes.TextBlock}>
                <div className={classes.Title}>Le conseil de communauté</div>
                <div className={classes.rectangle}></div>
                    <div className={classes.Text}>
            ...
            <div className={classes.TextBlock}>
                <div className={classes.Title}>Le bureau communautaire</div>
                <div className={classes.rectangle}></div>
                <div className={classes.Text}>
            ...
            <div className={classes.TextBlock}>
                <div className={classes.Title}>Les commissions</div>
                <div className={classes.rectangle}></div>
                <div className={classes.Text}>
